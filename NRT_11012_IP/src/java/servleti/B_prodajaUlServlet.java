 ...
 * @author POPOV
 */
public class B_prodajaUlServlet extends HttpServlet {

    String odgovor="<p>nista se nije desilo</p>";
    String potvrda="<h3>Nije uspela prodaja karata!</h3>";
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>B_prodajaUlServlet</title>");  
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String IDkatS=request.getParameter("IDkat");
        int IDkat=Integer.parseInt(IDkatS.trim());
        String brUlS=request.getParameter("brUl");
        int brUl=Integer.parseInt(brUlS.trim());
        
        //treba da nadjem DOGADJAJ za koji su prodate karte i procitam PRODATE
        ...
        try{
            ...
            while(rez3.next()){
                ...
                odgovor+="<p>prodate "+prodate+" </p>";
                
                String[] nizRez=prodate.split("/");
        ...
        try{
            ...
            upit4.executeUpdate("UPDATE dogadjaj SET prodate='"+rezNOVO+"' WHERE ID="+dogadjajID+"");
            odgovor+="<p>uspesno ste UPDATE dogadjaj kolona REZERVISANE </p>";
            potvrda="<h3>Uspesna prodaja karata!</h3>";
        }catch(SQLException e){
            //out.println("Greska: " + e);
            sesija.setAttribute("greska",e.toString());
            RequestDispatcher dispatcher = request.getRequestDispatcher("greske.jsp");
